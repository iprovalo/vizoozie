...
class Test(unittest.TestCase):
    ...
    provided_decision = '<decision name=\"is_cleanse\"><switch><case to=\"cleanse\">${wf:conf(\"cleanse\") == \"true\"}</case><default to=\"end\" /></switch></decision>'

    
    def setUp(self):
        unittest.TestCase.setUp(self)
        self.vizoozie = VizOozie()

    def test_e2e(self):
        result = self.vizoozie.convertWorkflowXMLToDOT(self.provided_complete, 'test')
